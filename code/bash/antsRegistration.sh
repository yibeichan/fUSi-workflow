...
antsRegistration --dimensionality 3 \
    --float 0 \
    --output [aligned_, aligned_Warped.nii.gz] \
    --interpolation Linear \
    --use-histogram-matching 1 \
    --initial-moving-transform [../atlas/template_T1w_brain.nii.gz, reoriented_CT.nii.gz, 1] \
    --transform Rigid[0.1] \
    --metric MI[../atlas/template_T1w_brain.nii.gz, reoriented_CT.nii.gz, 1, 32, Regular, 0.25] \
